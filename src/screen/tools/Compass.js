    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.imageContainer} >
          <Animated.Image resizeMode='contain' source={require('../../assets/compass/compass.png')}
            style={{
        ...
        <View style={styles.arrowContainer} >
          <Image resizeMode='contain' source={require('../../assets/compass/arrow.png')} style={styles.arrow} />
        </View>
      </View>
    );
  }
